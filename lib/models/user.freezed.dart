...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, phone: $phone, workplace: $workplace, userType: $userType)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, name, phone, workplace, userType);
...
abstract class _User implements User {
  const factory _User(
      ...
      required final Workplace workplace,
